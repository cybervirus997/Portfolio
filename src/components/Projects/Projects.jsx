                ...
                <div className="projects" id="projects" style={{backgroundColor: theme.secondary}}>
                    ...
                    <div className="projects--body">
                        <div className="projects--bodyContainer">
                            <button style={{ borderRadius: "50%", width: "39px", border: "none", height: "39px", outline: "none" }} onClick={handlePrev}>
                            ...
                            <button style={{ borderRadius: "50%", width: "39px", border: "none", height: "39px", outline: "none" }} onClick={handleNext}>
